...
const CTABanner = () => {
    ...
    const badgeText = getSetting('cta_badge', 'Start Generating Repeat Revenue')
    const title = getSetting('cta_banner_title', 'Ready to Build a High-Performing Airbnb?')
    const subtitle = getSetting('cta_banner_subtitle', 'Launch your listing, optimize your pricing, and build a system that guarantees repeat bookings.')
    const ctaButton = getSetting('cta_banner_button', 'Book a Call')
    ...
    return (
        <section className="w-full relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#534d1b]/95 via-[#3e3a14]/90 to-[#151307]/95 z-[1]" />
