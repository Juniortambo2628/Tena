...
const TestimonialsSection = () => {
    ...
    const items = [
        { id: 1, quote: "We went from inconsistent bookings to fully booked.", rating: 5, client_name: "Airbnb Host", role: "Property Owner", company: "Local Listings" },
        { id: 2, quote: "The strategy alone paid for itself.", rating: 5, client_name: "Real Estate Investor", role: "Investor", company: "Multi-Unit Portfolio" },
        { id: 3, quote: "We finally understand Airbnb as a business.", rating: 5, client_name: "First-time Host", role: "Host", company: "Downtown Apartment" },
    ]
